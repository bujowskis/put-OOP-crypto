 ...
 */
MemeWork::MemeWork(string name, char symbol, int amount, float exchange_rate, string authors, bool can_create,
...
virtual MemeWork::~MemeWork() { } // nothing to do here

/* Prints detailed info about given currency */
void MemeWork::toString() {
