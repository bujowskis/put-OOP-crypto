 ...
 */
SeriousWork::SeriousWork(string name, char symbol, int amount, float exchange_rate, string authors, bool can_create,
...
virtual SeriousWork::~SeriousWork() { } // nothing to do here

/* Prints detailed info about given currency */
void SeriousWork::toString() {
